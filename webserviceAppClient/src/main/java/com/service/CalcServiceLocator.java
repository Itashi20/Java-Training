...
public class CalcServiceLocator extends org.apache.axis.client.Service implements com.service.CalcService {
    ...
    private java.lang.String Calc_address = "http://localhost:8080/webserviceApp/services/Calc";
    ...
    public com.service.Calc getCalc(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.service.CalcSoapBindingStub _stub = new com.service.CalcSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.service.Calc.class.isAssignableFrom(serviceEndpointInterface)) {
                com.service.CalcSoapBindingStub _stub = new com.service.CalcSoapBindingStub(new java.net.URL(Calc_address), this);
                _stub.setPortName(getCalcWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://service.com", "CalcService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://service.com", "Calc"));
        }
